...
#ifndef Weighted_RPD_Beam_Position_Finder_Function
#define Weighted_RPD_Beam_Position_Finder_Function
			...
			if (side == 0) {
				//if (PosorNeg == "Neg"){
					//if (XorY == "Y") {
						...
						if (channel == 10 || channel == 14 || channel == 3 || channel == 7) { RPD_ROW_N[3] += fC_of_TS456_Summed * DataWeightsFromRun_326776[side][channel]; }	
				//	}																															//R0
					//if (XorY == "X") {																											//R1
				...
				//if (PosorNeg == "Pos"){
					//if (XorY == "Y") {
						...
						if (channel == 10 || channel == 14 || channel == 3 || channel == 7) { RPD_ROW_P[3] += fC_of_TS456_Summed * DataWeightsFromRun_326776[side][channel]; }			   
					//}																															//R0
					//if (XorY == "X") {																											//R1
