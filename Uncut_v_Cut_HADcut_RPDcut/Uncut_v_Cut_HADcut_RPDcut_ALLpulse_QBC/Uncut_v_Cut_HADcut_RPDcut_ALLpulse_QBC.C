...
void Uncut_v_Cut_HADcut_RPDcut_ALLpulse_QBC(int runnumber=327560){
  initRootStyle();
 
  //CUTOFF VALUE FOR GENERATING fC VS TS HISTOS SET BELOW//
  double CutOff = .8;////
  //CUTOFF VALUE FOR GENERATING fC VS TS HISTOS SET ABOVE//
  cout << "Running SOFTWARE: Uncut_v_Cut_HADcut_RPDcut_ALLpulse_QBC.C 3/13/19 11:19" << endl;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if((signal45/signal456 < CutOff) || (Seven  >= Five) || (One/Zero > 1000 && Zero != 0)){
