...
void RPD_TS_RATIOS_45_456_and_7v5_EventSelector_4by4_RPDTSDistCORRECTQBLAYOUT(int runnumber=327560){
  initRootStyle();
  //CUTOFF VALUE FOR GENERATING fC VS TS HISTOS SET BELOW//
  double CutOff = .6;////
  //CUTOFF VALUE FOR GENERATING fC VS TS HISTOS SET ABOVE//
  cout << "Running SOFTWARE: RPD_TS_RATIOS_45_456_and_7v5_EventSelector_4by4_RPDTSDistCORRECTQBLAYOUT.C 3/13/19 4:00" << endl;
  cout << "Runnumber=" << runnumber << " many" << endl;
  cout << "CutOff 45 456 = " << CutOff << "or 7>= 5 or 1> three*3" << endl;
...
//declaring variables to hold channel charge for 45 and 456 for all RPD pos and neg
	...
	if((signal45/signal456 < CutOff) || (Seven  >= Five) || (One/Zero > 1000 && Zero != 0)){  //(signal45/signal456 < CutOff) || (Seven  >= Five)
	cout << One << "Other is Zero >" << Zero << endl;
   ...
   TCanvas *c4 = new TCanvas("c4", "RUN 327560", 2000, 1500);
        c4->Divide(4,4,0.0001,0.0001); //assumes canvas is called c1 and creates a different canvas c2 then divides canvas into p by p matrix
			...
			fC_RPD[1][7]->Draw("hist e");
			   ...
			   c4->SaveAs(Form("ZDC_figures/RPD_45456_Ratio_Run/4x4_5x2_RPDZDC_TS/CORRECTQBLAYOUT_fC_RPD_Plus_channel_signal45vsignal456_less_CutOff_or_Seven_greaterorequal_Five_or_OnevZero_greaterthan_1000andZero_notequal_0_ALL_327560.png"));
			...
			fC_RPD[0][7]->Draw("hist e");
			  /* for(int i = 1; i < 17; i++){
			   ...
			   c4->SaveAs(Form("ZDC_figures/RPD_45456_Ratio_Run/4x4_5x2_RPDZDC_TS/CORRECTQBLAYOUT_fC_RPD_Minus_channelCORRECTQBLAYOUT_fC_RPD_Plus_channel_signal45vsignal456_less_CutOff_or_Seven_greaterorequal_Five_or_OnevZero_greaterthan_1000andZero_notequal_0_ALL_327560.png"));
	...
	TCanvas *c5 = new TCanvas("c5", "RUN 327560", 2000, 2000);
		c5->Divide(5,4,0.0001,0.0001); //x=5 y =2 i think this allows for row 1 = em r2 = had 
			...
			c5->Update();  
			c5->SaveAs(Form("ZDC_figures/RPD_45456_Ratio_Run/4x4_5x2_RPDZDC_TS/fC_ZDC_Negative_signal45vsignal456_less_CutOff_or_Seven_greaterorequal_Five_or_OnevZero_greaterthan_1000andZero_notequal_0.png"));
			...
			c5->Update();  
			c5->SaveAs(Form("ZDC_figures/RPD_45456_Ratio_Run/4x4_5x2_RPDZDC_TS/fC_ZDC_Positive_signal45vsignal456_less_CutOff_or_Seven_greaterorequal_Five_or_OnevZero_greaterthan_1000andZero_notequal_0.png"));
