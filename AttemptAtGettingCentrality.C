...
//main function macro
void AttemptAtGettingCentrality(int runnumber=326776){
	initRootStyle();
	...
	cout << "a" << endl;
	TFile *f = new TFile("/home/ebadams/CMSSW_10_3_3/src/ZDC/newZDCAnalyzer/test/Tracks_AOD_zdc_digi_tree_326822.root"); cout << "Dataset=" << "Tracks_AOD_zdc_digi_tree_326822.root" << endl; // opening the root file
