...
//main function macro
void ThreeTwoSixSevenSevenSixWeights_EMBeam_Selection_RPD_REALWEIGHTS_counts_v_fC(int runnumber=326776)
{
	initRootStyle();
	
	cout << "Running SOFTWARE: ThreeTwoSixSevenSevenSixWeights_EMBeam_Selection_RPD_REALWEIGHTS_counts_v_fC.C 4/9/19 4:07" << endl;
