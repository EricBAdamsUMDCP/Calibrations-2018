...
void HAD_CUT_ForBadPrepulseSearch_RPD_TS_RATIOS_45_456_and_HAD1_RATIO_EventSelector_4by4_RPDTSDistCORRECTQBLAYOUT(int runnumber=286178){
  initRootStyle();
  //CUTOFF VALUE FOR GENERATING fC VS TS HISTOS SET BELOW//
  double CutOff = .6;////
  //CUTOFF VALUE FOR GENERATING fC VS TS HISTOS SET ABOVE//
  cout << "Running SOFTWARE: HAD_CUT_ForBadPrepulseSearch_RPD_TS_RATIOS_45_456_and_HAD1_RATIO_EventSelector_4by4_RPDTSDistCORRECTQBLAYOUT";
	  ...
	  TH1F* fC_RPDHT[2][16];
		...
		for(int j = 0; j < 2; j++)
		  for(int k = 0; k < 5; k++){
			...
			fC_ZDCHT[i][j][k] = new TH1F(Form("fC ZDCHT %s%s channel %d",ttit[j],stit[i],k+1),Form("ZDCHT %s%s channel %d;TS [25 ns];Q [fC]",ttit[j],stit[i],k+1),10,-0.5,9.5); 
		  }

		for(int j = 0; j < 16; j++){
		  
		  fC_RPDHT[i][j] = new TH1F(Form("fC RPDHT%s channel %d",stit[i],j+1),Form("RPDHT%s channel %d;TS [25 ns];Q [fC]",stit[i],j+1),10,-0.5,9.5);
		}
...
//declaring variables to hold channel charge for 45 and 456 for all RPD pos and neg
	...
	if(signal1/signal12 < 0.2 || 0.8 < signal1/signal12){ //range is peak of HAD ratio excluding 0 and 1 ratio peaks as this implies either there is little prepulse of the prepulse is equal in 0 and 1. Our observations have shown the prepulse is generally veryy large in TS 1 and minimal in TS 2
	for(int iTS = 0; iTS < 10; iTS++){
			if(type != 3){ // EM or HAD section
	...
	//pos/////////////////////////////////////////////////
		...
		/*HAD*/HAD112_CH1_Pos->Fill(HAD_Pos_1_1/HAD_Pos_1_12);
	...
	//////////////////////////////////////////////////////
		...
		/*HAD*/HAD112_CH1_Neg->Fill(HAD_Neg_1_1/HAD_Neg_1_12);
  ...
  TFile f2("ratio.root","RECREATE"); 
    ...
    //pos drawing and saving histos
		/*HAD*/ HAD112_CH1_Pos->SetLineColor(4);
	...
	/////////////////////////////////
		/*HAD*/ HAD112_CH1_Neg->SetLineColor(4);
	...
	TCanvas *c2 = new TCanvas("c2", ";45/456 ALL Pos RUN 327560;, 2000, 1500");
			...
			gPad-> SetLogy();
			RPD45456_CH8_Pos->Draw("hist e");
			c2->SaveAs("ZDC_figures/HAD_BadSignalSearch_RPD_45456_Ratio_Run/CORRECTQBLAYOUT_RPD45456_CHALL_Pos.png");
			//RPD + 3/8/19
			//12, 16, 3 ,6
			//9, 13, 2 ,7
		   //10, 14, 1 ,5
	...
	TCanvas *c3 = new TCanvas("c3", ";45/456 ALL Neg RUN 327560;, 2000, 1500"); // because we are not declaring histograms it is necessary to add a 3rd canvas
		...
		c3->Divide(4,4,0.0001,0.0001);
			...
			gPad->SetLogy();
			RPD45456_CH8_Neg->Draw("hist e");
			c3->SaveAs("ZDC_figures/HAD_BadSignalSearch_RPD_45456_Ratio_Run/CORRECTQBLAYOUT_RPD45456_CHALL_Neg.png");
			//RPD - 3/8/19
			//12, 16, 3 ,7
			//9, 13, 2 ,6
		   //10, 14, 1 ,5
   ...
   TCanvas *c4 = new TCanvas("c4", "RUN 327560", 2000, 1500);
		...
		c4->Divide(4,4,0.0001,0.0001); //assumes canvas is called c1 and creates a different canvas c2 then divides canvas into p by p matrix
			...
			fC_RPD[1][7]->Draw("hist e");
			   ...
			   c4->SaveAs(Form("ZDC_figures/HAD_BadSignalSearch_RPD_45456_Ratio_Run/4x4_5x2_RPDZDC_TS/HAD_BadSignalSearch_CORRECTQBLAYOUT_fC_RPD_Plus_channel_ALL_327560.png"));
			...
			fC_RPD[0][7]->Draw("hist e");
			  /* for(int i = 1; i < 17; i++){
			   ...
			   c4->SaveAs(Form("ZDC_figures/HAD_BadSignalSearch_RPD_45456_Ratio_Run/4x4_5x2_RPDZDC_TS/HAD_BadSignalSearch_CORRECTQBLAYOUT_fC_RPD_Minus_channel_ALL_327560.png"));
			//////////////////////
			//HAD TRIGGER Histos//
			//////////////////////
			...
			fC_RPDHT[1][7]->Draw("hist e");
			   ...
			   c4->SaveAs(Form("ZDC_figures/HAD_BadSignalSearch_RPD_45456_Ratio_Run/4x4_5x2_RPDZDC_TS/HAD_BadSignalSearch_CORRECTQBLAYOUT_fC_RPDHT_Plus_channel_ALL_327560.png"));
			...
			fC_RPDHT[0][7]->Draw("hist e");
			  /* for(int i = 1; i < 17; i++){
			   ...
			   c4->SaveAs(Form("ZDC_figures/HAD_BadSignalSearch_RPD_45456_Ratio_Run/4x4_5x2_RPDZDC_TS/HAD_BadSignalSearch_CORRECTQBLAYOUT_fC_RPDHT_Minus_channel_ALL_327560.png"));
	...
	TCanvas *c5 = new TCanvas("c5", "RUN 327560", 2000, 2000);
		c5->Divide(5,4,0.0001,0.0001); //x=5 y =2 i think this allows for row 1 = em r2 = had 
			...
			c5->Update();  
			//c5->SaveAs(Form("ZDC_figures/HAD_BadSignalSearch_RPD_45456_Ratio_Run/4x4_5x2_RPDZDC_TS/HAD_BadSignalSearch_fC_ZDC_Negative.png"));
			...
			c5->Update();  
			c5->SaveAs(Form("ZDC_figures/HAD_BadSignalSearch_RPD_45456_Ratio_Run/4x4_5x2_RPDZDC_TS/HAD_BadSignalSearch_fC_ZDC_Positive.png"));
			...
			c5->Update();  
			//c5->SaveAs(Form("ZDC_figures/HAD_BadSignalSearch_RPD_45456_Ratio_Run/4x4_5x2_RPDZDC_TS/HAD_BadSignalSearch_fC_ZDCHT_Negative.png"));
																					//c5->SaveAs(Form("ZDC_figures/RPD_45456_Ratio_Run/fC_ZDC_%s_%s_channel_%d.png",ttit[itype],stit2[iside],ich+1));
			//////////////////	
			//Pos EM AND HAD//
			//////////////////
			...
			c5->Update();  
			c5->SaveAs(Form("ZDC_figures/HAD_BadSignalSearch_RPD_45456_Ratio_Run/4x4_5x2_RPDZDC_TS/HAD_BadSignalSearch_fC_ZDCHT_Positive.png"));
